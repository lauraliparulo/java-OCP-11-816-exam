...
public class TestWithStreamDropAndTakeWhile {
	...
	public static void main(String[] args) {
		...
		streamSupplier.get().dropWhile(p -> p.getAge()>AGE_TRESHHOLD).forEach(p -> System.out.println(p));
		//after the drop it takes the person aged 37 too
		
		System.out.println("---");
		streamSupplier.get().takeWhile(p -> p.getAge()>AGE_TRESHHOLD).forEach(p -> System.out.println(p));
